...
class PacienteForm(ModelForm):
    class Meta:
        model = Paciente
        fields = ['nombre', 'apellido','servicio', 'habitacion', 'cama', 'diagnostico' ]
        widgets = {
            ...
            'diagnostico': forms.TextInput(attrs={'class': 'bg-zinc-300 p-3 rounded-lg block w-full mb-3 hover:shadow-md hover:shadow-zinc-500/50'})
